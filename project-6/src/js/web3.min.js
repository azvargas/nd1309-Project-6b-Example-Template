...
()({
            ...
            d.prototype.encodeMultiWithOffset = function (t, e, r, o) {
                ...
                return t.forEach(function (s, c) {
                    if (h(e[c], t[c])) {
                        ...
                        i += a.encodeWithOffset(t[c], e[c], r[c], o)
                }),
                ...
                if (c !== s) {
                    ...
                    if (e.isDynamicArray(u))
                        for (var p = c === i ? 2 : 0, h = 0; h < r.length; h++)
                            c === i ? p += +r[h - 1][0] || 0 : c === a && (p +=  + (r[h - 1] || [])[0] || 0), l += n.formatInputInt(o + h * f + 32 * p).encode();
    ...
    14: [function (t, e, r) {
            ...
            i.prototype.encode = function (t, e) {
                ...
                return this.isDynamicArray(e) ? (r = t.length, o = a.nestedName(e), (i = []).push(n.formatInputInt(r).encode()), t.forEach(function (t) {
                    ...
                    for (var r = a.staticArrayLength(e), n = a.nestedName(e), o = [], i = 0; i < r; i++)
            ...
            i.prototype.decode = function (t, e, r) {
                ...
                if (this.isDynamicArray(r))
                    return function () {
                        for (var n = parseInt("0x" + t.substr(2 * e, 64)), o = parseInt("0x" + t.substr(2 * n, 64)), i = n + 32, a = c.nestedName(r), s = c.staticPartLength(a), u = 32 * Math.floor((s + 31) / 32), f = [], l = 0; l < o * u; l += u)
                ...
                if (this.isStaticArray(r))
                    return function () {
                        for (var n = c.staticArrayLength(r), o = e, i = c.nestedName(r), a = c.staticPartLength(i), s = 32 * Math.floor((a + 31) / 32), u = [], f = 0; f < n * s; f += s)
                            u.push(c.decode(t, o + f, i));
                        return u
                    }
                ();
                if (this.isDynamicType(r))
                    return n = parseInt("0x" + t.substr(2 * e, 64)), i = parseInt("0x" + t.substr(2 * n, 64)), a = Math.floor((i + 31) / 32), s = new o(t.substr(2 * n, 64 * (1 + a)), 0), c._outputFormatter(s, r);
    ...
    19: [function (t, e, r) {
            ...
            e.exports = function (t, e) {
                return e && "hex" === e.encoding && (t.length > 2 && "0x" === t.substr(0, 2) && (t = t.substr(2)), t = n.enc.Hex.parse(t)),
                o(t, {
                    outputLength: 256
                }).toString()
            }
    ...
    20: [function (t, e, r) {
            ...
            l = function (t) {
                ...
                var e = a[t];
                if (void 0 === e)
                    throw new Error("This unit doesn't exists, please use the one of the following units" + JSON.stringify(a, null, 2));
                return new n(e, 10)
            },
            p = function (t) {
                ...
                o = t._eth.filter("latest", function (i) {
                    if (!i && !n)
                        if (++r > 50) {
                            ...
                            t._eth.getTransactionReceipt(t.transactionHash, function (r, i) {
                                i && i.blockHash && !n && t._eth.getCode(i.contractAddress, function (r, a) {
                                    if (!n && a)
                                        if (o.stopWatching(function () {}), n = !0, a.length > 3)
                                            t.address = i.contractAddress, u(t), f(t), e && e(null, t);
                                        else {
                                            if (!e)
    ...
    27: [function (t, e, r) {
            ...
            u.prototype.encode = function (t, e) {
                ...
                return r.topics = r.topics.concat(a),
                r
            },
            u.prototype.decode = function (t) {
                t.data = t.data || "",
                ...
                return s.event = this.displayName(),
                s.address = t.address,
                s.args = this._params.reduce(function (t, e) {
                    return t[e.name] = e.indexed ? r.shift() : a.shift(),
                    t
                }, {}),
                delete s.data,
                delete s.topics,
    ...
    28: [function (t, e, r) {
            ...
            e.exports = function (t) {
                var e = function (e) {
                    var r;
                    e.property ? (t[e.property] || (t[e.property] = {}), r = t[e.property]) : r = t,
    ...
    29: [function (t, e, r) {
                ...
                this.implementation.newFilter(this.options, function (t, e) {
                    if (t)
                        p.callbacks.forEach(function (e) {
                            ...
                            a(p, t)
                        }), p.callbacks.length > 0 && s(p), "function" == typeof f)
                        return p.watch(f)
                }),
                this
            };
            c.prototype.watch = function (t) {
                ...
                this.filterId && (a(this, t), s(this)),
                this
            },
            c.prototype.stopWatching = function (t) {
                if (this.requestManager.stopPolling(this.filterId), this.callbacks = [], !t)
    ...
    34: [function (t, e, r) {
            ...
            i = function (t, e) {
                ...
                this.connection.on("data", function (t) {
                    r._parseResponse(t.toString()).forEach(function (t) {
                        ...
                        r.responseCallbacks[e] && (r.responseCallbacks[e](null, t), delete r.responseCallbacks[e])
                    })
                })
            };
            ...
            i.prototype._timeout = function () {
                for (var t in this.responseCallbacks)
                    this.responseCallbacks.hasOwnProperty(t) && (this.responseCallbacks[t](o.InvalidConnection("on IPC")), delete this.responseCallbacks[t])
            },
            i.prototype.isConnected = function () {
    ...
    46: [function (t, e, r) {
            ...
            s.prototype.reset = function (t) {
                for (var e in this.polls)
                    t && -1 !== e.indexOf("syncPoll_") || (this.polls[e].uninstall(), delete this.polls[e]);
                0 === Object.keys(this.polls).length && this.timeout && (clearTimeout(this.timeout), this.timeout = null)
            },
    ...
    48: [function (t, e, r) {
            ...
            a = function (t, e) {
                ...
                (r = this).requestManager.startPolling({
                    ...
                    o.isObject(e) && e.startingBlock && (e = n.outputSyncingFormatter(e)),
                ...
                return function () {
                    ...
                    m = n.AES = r.extend({
                            ...
                            if (!this._nRounds || this._keyPriorReset !== this._key) {
                                for (var t = this._keyPriorReset = this._key, e = t.words, r = t.sigBytes / 4, n = 4 * ((this._nRounds = r + 6) + 1), i = this._keySchedule = [], a = 0; a < n; a++)
                                    if (a < r)
                                        ...
                                        var s = i[a - 1];
                                        a % r ? r > 6 && a % r == 4 && (s = o[s >>> 24] << 24 | o[s >>> 16 & 255] << 16 | o[s >>> 8 & 255] << 8 | o[255 & s]) : (s = o[(s = s << 8 | s >>> 24) >>> 24] << 24 | o[s >>> 16 & 255] << 16 | o[s >>> 8 & 255] << 8 | o[255 & s], s ^= d[a / r | 0] << 24),
                                        i[a] = i[a - r] ^ s
                                    }
                        ...
                        _doCryptBlock: function (t, e, r, n, o, i, a, s) {
                            ...
                            m = (s[u >>> 24] << 24 | s[f >>> 16 & 255] << 16 | s[l >>> 8 & 255] << 8 | s[255 & p]) ^ r[h++],
                            y = (s[f >>> 24] << 24 | s[l >>> 16 & 255] << 16 | s[p >>> 8 & 255] << 8 | s[255 & u]) ^ r[h++],
                            g = (s[l >>> 24] << 24 | s[p >>> 16 & 255] << 16 | s[u >>> 8 & 255] << 8 | s[255 & f]) ^ r[h++],
                            v = (s[p >>> 24] << 24 | s[u >>> 16 & 255] << 16 | s[f >>> 8 & 255] << 8 | s[255 & l]) ^ r[h++];
                            t[e] = m,
                            t[e + 1] = y,
                            t[e + 2] = g,
                            t[e + 3] = v
    ...
    52: [function (t, e, r) {
            ...
            o = function () {
                ...
                f,
                l,
                p = p || (t = Math, e = Object.create || function () {
                    function t() {}
                    return function (e) {
                        var r;
                    ...
                    e.enc.Base64 = {
                        stringify: function (t) {
                            ...
                            for (var o = [], i = 0; i < r; i += 3)
                                for (var a = (e[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (e[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | e[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, s = 0; s < 4 && i + .75 * s < r; s++)
            ...
            o = function (t) {
                ...
                e.algo.HMAC = r.extend({
                    init: function (t, e) {
                        ...
                        e.clamp();
                        for (var i = this._oKey = e.clone(), a = this._iKey = e.clone(), s = i.words, c = a.words, u = 0; u < r; u++)
                ...
                return function () {
                    ...
                    s = n.RabbitLegacy = r.extend({
                        ...
                        _doProcessBlock: function (t, e) {
                            ...
                            for (var n = 0; n < 4; n++)
                                o[n] = 16711935 & (o[n] << 8 | o[n] >>> 24) | 4278255360 & (o[n] << 24 | o[n] >>> 8), t[e + n] ^= o[n]
                        },
                        blockSize: 4,
                        ivSize: 2
                    });
                ...
                return function (e) {
                    ...
                    h = a.RIPEMD160 = i.extend({
                        ...
                        _doProcessBlock: function (t, e) {
                            ...
                            A = w = F[4];
                            for (r = 0; r < 80; r += 1)
                                C = i + t[e + N[r]] | 0, C += r < 16 ? d(a, h, _) + O[0] : r < 32 ? m(a, h, _) + O[1] : r < 48 ? y(a, h, _) + O[2] : r < 64 ? g(a, h, _) + O[3] : v(a, h, _) + O[4], C = (C = b(C |= 0, P[r])) + w | 0, i = w, w = _, _ = b(h, 10), h = a, a = C, C = x + t[e + T[r]] | 0, C += r < 16 ? v(k, B, S) + I[0] : r < 32 ? g(k, B, S) + I[1] : r < 48 ? y(k, B, S) + I[2] : r < 64 ? m(k, B, S) + I[3] : d(k, B, S) + I[4], C = (C = b(C |= 0, D[r])) + A | 0, x = A, A = S, S = b(B, 10), B = k, k = C;
                            C = F[1] + h + S | 0,
                            F[1] = F[2] + _ + A | 0,
                            F[2] = F[3] + w + x | 0,
                            F[3] = F[4] + i + k | 0,
                ...
                return function (e) {
                    ...
                    !function () {
                        ...
                        for (var n = 2, o = 0; o < 64; )
                            t(n) && (o < 8 && (s[o] = r(e.pow(n, .5))), c[o] = r(e.pow(n, 1 / 3)), o++), n++
                    }
                    ();
                    var u = [],
                    f = a.SHA256 = i.extend({
                        ...
                        _doProcessBlock: function (t, e) {
                            ...
                            for (var s = 0; s < 24; s++) {
                                ...
                                for (var w = 1; w < 25; w++) {
                                    ...
                                    B = c[w];
                                    if (B < 32)
                                        h = x << B | k >>> 32 - B, d = k << B | x >>> 32 - B;
                                    else
                                        h = k << B - 32 | x >>> 64 - B, d = x << B - 32 | k >>> 64 - B;
                                    var S = l[u[w]];
                                    S.high = h,
                                    S.low = d
                                }
                    ...
                    var f = a.SHA512 = r.extend({
                        ...
                        _doProcessBlock: function (t, e) {
                            for (var r = this._hash.words, n = r[0], o = r[1], i = r[2], a = r[3], s = r[4], f = r[5], l = r[6], p = r[7], h = n.high, d = n.low, m = o.high, y = o.low, g = i.high, v = i.low, b = a.high, _ = a.low, w = s.high, x = s.low, k = f.high, B = f.low, S = l.high, A = l.low, C = p.high, F = p.low, O = h, I = d, N = m, T = y, P = g, D = v, R = b, E = _, M = w, H = x, j = k, q = B, z = S, L = A, U = C, W = F, J = 0; J < 80; J++) {
                                var K = u[J];
                                if (J < 16)
                                    var G = K.high = 0 | t[e + 2 * J], X = K.low = 0 | t[e + 2 * J + 1];
                                else {
                                    var $ = u[J - 15],
                                    V = $.high,
                                    Z = $.low,
                                ...
                                j = M,
                                q = H,
                                M = R + (kt = (kt = (kt = kt + pt + ((lt = lt + ht) >>> 0 < ht >>> 0 ? 1 : 0)) + wt + ((lt = lt + xt) >>> 0 < xt >>> 0 ? 1 : 0)) + G + ((lt = lt + X) >>> 0 < X >>> 0 ? 1 : 0)) + ((H = E + lt | 0) >>> 0 < E >>> 0 ? 1 : 0) | 0,
                                R = P,
                                E = D,
                                P = N,
                                D = T,
                                N = O,
                                T = I,
                                O = kt + (yt + dt + (Bt >>> 0 < gt >>> 0 ? 1 : 0)) + ((I = lt + Bt | 0) >>> 0 < lt >>> 0 ? 1 : 0) | 0
                            }
                            d = n.low = d + I,
                    ...
                    l = i.DES = o.extend({
                        _doReset: function () {
                            ...
                            for (var o = this._subKeys = [], i = 0; i < 16; i++) {
                                ...
                                f = c[i];
                                for (r = 0; r < 24; r++)
                                    u[r / 6 | 0] |= e[(s[r] - 1 + f) % 28] << 31 - r % 6, u[4 + (r / 6 | 0)] |= e[28 + (s[r + 24] - 1 + f) % 28] << 31 - r % 6;
                                u[0] = u[0] << 1 | u[0] >>> 31;
                                for (r = 1; r < 7; r++)
                                    u[r] = u[r] >>> 4 * (r - 1) + 3;
                                u[7] = u[7] << 5 | u[7] >>> 27
                        ...
                        _doCryptBlock: function (t, e, r) {
                            ...
                            for (var n = 0; n < 16; n++) {
                                for (var o = r[n], i = this._lBlock, a = this._rBlock, s = 0, c = 0; c < 8; c++)
                                    s |= u[c][((a ^ o[c]) & f[c]) >>> 0];
                                this._lBlock = a,
                                this._rBlock = i ^ s
                            }
    ...
    83: [function (t, e, r) {
            ...
            o = function (t) {
                ...
                i.WordArray = n.extend({
                    ...
                    clone: function () {
                        for (var t = n.clone.call(this), e = t.words = this.words.slice(0), r = e.length, o = 0; o < r; o++)
                            e[o] = e[o].clone();
                        return t
                    }
                }),
            ...
            !function (t) {
                ...
                function h(t) {
                    if (0 == (4294967168 & t))
                        return u(t);
                    var e = "";
                    return 0 == (4294965248 & t) ? e = u(t >> 6 & 31 | 192) : 0 == (4294901760 & t) ? (l(t), e = u(t >> 12 & 15 | 224), e += p(t, 6)) : 0 == (4292870144 & t) && (e = u(t >> 18 & 7 | 240), e += p(t, 12), e += p(t, 6)),
                    e += u(63 & t | 128)
                }
                function d() {
                    if (c >= s)
                ...
                function m() {
                    ...
                    if (240 == (248 & t) && (e = (7 & t) << 18 | d() << 12 | d() << 6 | d()) >= 65536 && e <= 1114111)
                        return e;
                    ...
                    decode: function (t) {
                        ...
                        return function (t) {
                            for (var e, r = t.length, n = -1, o = ""; ++n < r; )
                                (e = t[n]) > 65535 && (o += u((e -= 65536) >>> 10 & 1023 | 55296), e = 56320 | 1023 & e), o += u(e);
                            return o
                        }
                        (r)
                    }
            ...
            !function (t) {
                ...
                function w(t, e, r) {
                    for (var n, o, i = [0], a = 0, s = t.length; a < s; ) {
                        ...
                        for (i[n = 0] += u.indexOf(t.charAt(a++)); n < i.length; n++)
                            i[n] > r - 1 && (null == i[n + 1] && (i[n + 1] = 0), i[n + 1] += i[n] / r | 0, i[n] %= r)
                    }
                    return i.reverse()
                }
                function x(t, e) {
                ...
                (r = function t(e) {
                    ...
                    function X(t, e) {
                        ...
                        d = this;
                        if (!(d instanceof X))
                            return L && tt(26, "constructor call without new", t), new X(t, e);
                        if (null != e && U(e, 2, 64, P, "base")) {
                            if (h = t + "", 10 == (e |= 0))
                                return et(d = new X(t instanceof X ? t : h), E + d.e + 1, M);
                            if ((s = "number" == typeof t) && 0 * t != 0 || !new RegExp("^-?" + (r = "[" + u.slice(0, e) + "]+") + "(?:\\." + r + ")?$", e < 37 ? "i" : "").test(h))
                                return S(d, h, s, e);
                            s ? (d.s = 1 / t < 0 ? (h = h.slice(1), -1) : 1, L && h.replace(/^0\.0*|\./, "").length > 15 && tt(P, c, t), s = !1) : d.s = 45 === h.charCodeAt(0) ? (h = h.slice(1), -1) : 1,
                            h = $(h, 10, e, d.s)
                        } else {
                            if (t instanceof X)
                                return d.s = t.s, d.e = t.e, d.c = (t = t.c) ? t.slice() : t, void(P = 0);
                        ...
                        if (h = h.slice(a, f + 1))
                            if (f = h.length, s && L && f > 15 && (t > p || t !== i(t)) && tt(P, c, d.s * t), (o = o - a - 1) > z)
                                d.c = d.e = null;
                            else if (o < q)
                                d.c = [d.e = 0];
                            else {
                    ...
                    function $(t, e, n, o) {
                        ...
                        if (!l[0])
                            return "0";
                        if (h < 0 ? --a : (f.c = l, f.e = a, f.s = o, l = (f = r(f, p, d, m, e)).c, c = f.r, a = f.e), h = l[i = a + d + 1], s = e / 2, c = c || i < 0 || null != l[i + 1], c = m < 4 ? (null != h || c) && (0 == m || m == (f.s < 0 ? 3 : 2)) : h > s || h == s && (4 == m || c || 6 == m && 1 & l[i - 1] || m == (f.s < 0 ? 8 : 7)), i < 1 || !l[0])
                            t = c ? k("1", -d) : "0";
                        else {
                            if (l.length = i, c)
                                for (--e; ++l[--i] > e; )
                    ...
                    function V(t, e, r, n) {
                        ...
                        if (o = t.c[0], a = t.e, null == e)
                            u = g(t.c), u = 19 == n || 24 == n && a <= H ? x(u, a) : k(u, a);
                    ...
                    function Y(t, e, r, n, o) {
                        return (t < e || t > r || t != B(t)) && tt(n, (o || "decimal places") + (t < e || t > r ? " out of range" : " not an integer"), t),
                        !0
                    }
                    function Q(t, e, r) {
                        for (var n = 1, o = e.length; !e[--o]; e.pop());
                        for (o = e[0]; o >= 10; o /= 10, n++);
                        return (r = n + r * l - 1) > z ? t.c = t.e = null : r < q ? t.c = [t.e = 0] : (t.e = r, t.c = e),
                        t
                    }
                    function tt(t, e, r) {
                    ...
                    function et(t, e, r, n) {
                        ...
                        if (y) {
                            t: {
                                ...
                                if ((s = e - a) < 0)
                                    s += l, c = e, m = (p = y[d = 0]) / g[a - c - 1] % 10 | 0;
                                ...
                                if (n = n || e < 0 || null != y[d + 1] || (c < 0 ? p : p % g[a - c - 1]), n = r < 4 ? (m || n) && (0 == r || r == (t.s < 0 ? 3 : 2)) : m > 5 || 5 == m && (4 == r || n || 6 == r && (s > 0 ? c > 0 ? p / g[a - c] : 0 : y[d - 1]) % 10 & 1 || r == (t.s < 0 ? 8 : 7)), e < 1 || !y[0])
                                    return y.length = 0, n ? (e -= t.e + 1, y[0] = g[(l - e % l) % l], t.e = -e || 0) : y[0] = t.e = 0, t;
                                if (0 == s ? (y.length = d, u = 1, d--) : (y.length = d + 1, u = g[l - s], y[d] = c > 0 ? i(p / g[a - c] % g[c]) * u : 0), n)
                                    for (; ; ) {
                                        if (0 == d) {
                    ...
                    X.config = X.set = function () {
                        ...
                        return s(e = "DECIMAL_PLACES") && U(t, 0, m, 2, e) && (E = 0 | t),
                        n[e] = E,
                        s(e = "ROUNDING_MODE") && U(t, 0, 8, 2, e) && (M = 0 | t),
                        n[e] = M,
                        s(e = "EXPONENTIAL_AT") && (_(t) ? U(t[0], -m, 0, 2, e) && U(t[1], 0, m, 2, e) && (H = 0 | t[0], j = 0 | t[1]) : U(t, -m, m, 2, e) && (H =  - (j = 0 | (t < 0 ? -t : t)))),
                        n[e] = [H, j],
                        s(e = "RANGE") && (_(t) ? U(t[0], -m, -1, 2, e) && U(t[1], 1, m, 2, e) && (q = 0 | t[0], z = 0 | t[1]) : U(t, -m, m, 2, e) && (0 | t ? q =  - (z = 0 | (t < 0 ? -t : t)) : L && tt(2, e + " cannot be zero", t))),
                        n[e] = [q, z],
                        s(e = "ERRORS") && (t === !!t || 1 === t || 0 === t ? (P = 0, U = (L = !!t) ? Y : b) : L && tt(2, e + a, t)),
                        n[e] = L,
                        s(e = "CRYPTO") && (!0 === t || !1 === t || 1 === t || 0 === t ? t ? !(t = "undefined" == typeof crypto) && crypto && (crypto.getRandomValues || crypto.randomBytes) ? W = !0 : L ? tt(2, "crypto unavailable", t ? void 0 : crypto) : W = !1 : W = !1 : L && tt(2, e + a, t)),
                        n[e] = W,
                        s(e = "MODULO_MODE") && U(t, 0, 9, 2, e) && (J = 0 | t),
                        n[e] = J,
                        s(e = "POW_PRECISION") && U(t, 0, m, 2, e) && (K = 0 | t),
                        n[e] = K,
                        s(e = "FORMAT") && ("object" == typeof t ? G = t : L && tt(2, e + " not an object", t)),
                        n[e] = G,
                        n
                    },
                    X.max = function () {
                    ...
                    X.random = (A = 9007199254740992, C = Math.random() * A & 2097151 ? function () {
                        ...
                        u = [],
                        f = new X(R);
                        if (t = null != t && U(t, 0, m, 14) ? 0 | t : E, a = o(t / l), W)
                            if (crypto.getRandomValues) {
                                for (e = crypto.getRandomValues(new Uint32Array(a *= 2)); c < a; )
                                    (s = 131072 * e[c] + (e[c + 1] >>> 11)) >= 9e15 ? (r = crypto.getRandomValues(new Uint32Array(2)), e[c] = r[0], e[c + 1] = r[1]) : (u.push(s % 1e14), c += 2);
                                c = a / 2
                            } else if (crypto.randomBytes) {
                                for (e = crypto.randomBytes(a *= 7); c < a; )
                                    (s = 281474976710656 * (31 & e[c]) + 1099511627776 * e[c + 1] + 4294967296 * e[c + 2] + 16777216 * e[c + 3] + (e[c + 4] << 16) + (e[c + 5] << 8) + e[c + 6]) >= 9e15 ? crypto.randomBytes(7).copy(e, c) : (u.push(s % 1e14), c += 7);
                                c = a / 7
                            } else
                                W = !1, L && tt(14, "crypto unavailable", crypto);
                        if (!W)
                            for (; c < a; )
                                (s = C()) < 9e15 && (u[c++] = s % 1e14);
                    ...
                    r = function () {
                        function t(t, e, r) {
                            ...
                            f = e / d | 0;
                            for (t = t.slice(); c--; )
                                s = ((o = u * (i = t[c] % d) + (n = f * i + (a = t[c] / d | 0) * u) % d * d + s) / r | 0) + (n / d | 0) + f * a, t[c] = o % r;
                        ...
                        function r(t, e, r, n) {
                            for (var o = 0; r--; )
                                t[r] -= o, o = t[r] < e[r] ? 1 : 0, t[r] = o * n + t[r] - e[r];
                        ...
                        return function (n, o, a, s, c) {
                            ...
                            N = o.c;
                            if (!(I && I[0] && N && N[0]))
                                return new X(n.s && o.s && (I ? !N || I[0] != N[0] : N) ? I && 0 == I[0] || !N ? 0 * O : O / 0 : NaN);
                            ...
                            if (N[h] > (I[h] || 0) && p--, O < 0)
                                ...
                                do {
                                    if (m = 0, (u = e(N, w, C, x)) < 0) {
                                        if (k = w[0], C != x && (k = k * c + (w[1] || 0)), (m = i(k / A)) > 1)
                                            for (m >= c && (m = c - 1), v = (g = t(N, m, c)).length, x = w.length; 1 == e(g, w, v, x); )
                                                m--, r(g, C < v ? F : N, v, c), v = g.length, u = 1;
                                        else
                                            0 == m && (u = m = 1), v = (g = N.slice()).length;
                                        if (v < x && (g = [0].concat(g)), r(w, g, x, c), x = w.length, -1 == u)
                                            for (; e(N, w, C, x) < 1; )
                    ...
                    S = function (t, e, r, n) {
                        ...
                        if (N.test(i))
                            ...
                            if (!r && (i = i.replace(F, function (t, e, r) {
                                        return o = "x" == (r = r.toLowerCase()) ? 16 : "b" == r ? 2 : 8,
                                        n && n != o ? t : e
                                    }), n && (o = n, i = i.replace(O, "$1").replace(I, "0.$1")), e != i))
                                return new X(i, o);
                    ...
                    D.decimalPlaces = D.dp = function () {
                        ...
                        if (!r)
                            return null;
                        if (t = ((e = r.length - 1) - y(this.e / l)) * l, e = r[e])
                            for (; e % 10 == 0; e /= 10, t--);
                        return t < 0 && (t = 0),
                        t
                    },
                    ...
                    D.minus = D.sub = function (t, e) {
                        ...
                        if (!c || !u) {
                            ...
                            if (!p[0] || !h[0])
                                return h[0] ? (t.s = -e, t) : new X(p[0] ? a : 3 == M ? -0 : 0)
                        }
                        ...
                        if (i && (o = p, p = h, h = o, t.s = -t.s), (e = (n = h.length) - (r = p.length)) > 0)
                            for (; e--; p[r++] = 0);
                        for (e = f - 1; n > s; ) {
                            if (p[--n] < h[n]) {
                                for (r = n; r && !p[--r]; p[r] = e);
                    ...
                    D.modulo = D.mod = function (t, e) {
                        ...
                        return P = 11,
                        t = new X(t, e),
                        !i.c || !t.s || t.c && !t.c[0] ? new X(NaN) : !t.c || i.c && !i.c[0] ? new X(i) : (9 == J ? (o = t.s, t.s = 1, n = r(i, t, 0, 3), t.s = o, n.s *= o) : n = r(i, t, 0, J), i.minus(n.times(t)))
                    },
                    ...
                    D.plus = D.add = function (t, e) {
                        ...
                        for ((o = s.length) - (e = c.length) < 0 && (r = c, c = s, s = r, e = o), o = 0; e; )
                            o = (s[--e] = s[e] + c[e] + o) / f | 0, s[e] = f === s[e] ? 0 : s[e] % f;
                        return o && (s = [o].concat(s), ++a),
                        Q(t, s, a)
                    },
                    D.precision = D.sd = function (t) {
                        ...
                        r,
                        n = this.c;
                        if (null != t && t !== !!t && 1 !== t && 0 !== t && (L && tt(13, "argument" + a, t), t != !!t && (t = null)), !n)
                            return null;
                    ...
                    D.round = function (t, e) {
                        var r = new X(this);
                        return (null == t || U(t, 0, m, 15)) && et(r, ~~t + this.e + 1, null != e && U(e, 0, 8, 15, s) ? 0 | e : M),
                        r
                    },
                    D.shift = function (t) {
                        var e = this;
                    ...
                    D.squareRoot = D.sqrt = function () {
                        ...
                        l = new X("0.5");
                        if (1 !== c || !s || !s[0])
                            return new X(!c || c < 0 && (!s || s[0]) ? NaN : s ? a : 1 / 0);
                        if (0 == (c = Math.sqrt(+a)) || c == 1 / 0 ? (((e = g(s)).length + u) % 2 == 0 && (e += "0"), c = Math.sqrt(e), u = y((u + 1) / 2) - (u < 0 || u % 2), n = new X(e = c == 1 / 0 ? "1e" + u : (e = c.toExponential()).slice(0, e.indexOf("e") + 1) + u)) : n = new X(c + ""), n.c[0])
                            for ((c = (u = n.e) + f) < 3 && (c = 0); ; )
                                if (i = n, n = l.times(i.plus(r(a, i, f, 1))), g(i.c).slice(0, c) === (e = g(n.c)).slice(0, c)) {
                    ...
                    D.times = D.mul = function (t, e) {
                        ...
                        if (!(x && k && x[0] && k[0]))
                            return !w.s || !t.s || x && !x[0] && !k || k && !k[0] && !x ? t.c = t.e = t.s = null : (t.s *= w.s, x && k ? (t.c = [0], t.e = 0) : t.c = t.e = null), t;
                        for (n = y(w.e / l) + y(t.e / l), t.s *= w.s, (c = x.length) < (h = k.length) && (v = x, x = k, k = v, o = c, c = h, h = o), o = c + h, v = []; o--; v.push(0));
                        for (b = f, _ = d, o = h; --o >= 0; ) {
                            for (r = 0, m = k[o] % _, g = k[o] / _ | 0, i = o + (a = c); i > o; )
                                r = ((u = m * (u = x[--a] % _) + (s = g * u + (p = x[a] / _ | 0) * m) % _ * _ + v[i] + r) / b | 0) + (s / _ | 0) + g * p, v[i--] = u % b;
                            v[i] = r
                        }
                        return r ? ++n : v.splice(0, 1),
                        Q(t, v, n)
                    },
                    D.toDigits = function (t, e) {
                        var r = new X(this);
                        return t = null != t && U(t, 1, m, 18, "precision") ? 0 | t : null,
                    ...
                    D.toFraction = function (t) {
                        ...
                        v = n = new X(R),
                        b = c = new X(R);
                        if (null != t && (L = !1, s = new X(t), L = p, (p = s.isInt()) && !s.lt(R) || (L && tt(22, "max denominator " + (p ? "out of range" : "not an integer"), t), t = !p && s.c && et(s, s.e + 1, 1).gte(R) ? s : null)), !m)
                            return d.toString();
                        for (f = g(m), i = y.e = f.length - d.e - 1, y.c[0] = h[(a = i % l) < 0 ? l + a : a], t = !t || s.cmp(y) > 0 ? i > 0 ? y : v : s, a = z, z = 1 / 0, s = new X(f), c.c[0] = 0; u = r(s, y, 0, 1), 1 != (o = n.plus(u.times(b))).cmp(t); )
                            n = b, b = o, v = c.plus(u.times(o = v)), c = o, y = s.minus(u.times(o = y)), s = o;
                        return o = r(t.minus(n), b, 0, 1),
                        c = c.plus(o.times(v)),
                        n = n.plus(o.times(b)),
                        c.s = v.s = d.s,
                        e = r(v, b, i *= 2, M).minus(d).abs().cmp(r(c, n, i, M).minus(d).abs()) < 1 ? [v.toString(), b.toString()] : [c.toString(), n.toString()],
                        z = a,
                        e
                    },
                    D.toNumber = function () {
                    ...
                    D.toPower = D.pow = function (t, e) {
                        ...
                        s = i(t < 0 ? -t : +t),
                        c = this;
                        if (null != e && (P = 23, e = new X(e)), !U(t, -p, p, 23, "exponent") && (!isFinite(t) || s > p && (t /= 0) || parseFloat(t) != t && !(t = NaN)) || 0 == t)
                        ...
                        for (e ? t > 1 && c.gt(R) && c.isInt() && e.gt(R) && e.isInt() ? c = c.mod(e) : (a = e, e = null) : K && (r = o(K / l + 2)), n = new X(R); ; ) {
                            ...
                            if (!(s = i(s / 2)))
                                break;
                            c = c.times(c),
                            r ? c.c && c.c.length > r && (c.c.length = r) : e && (c = c.mod(e))
                        }
                    ...
                    D.toString = function (t) {
                        ...
                        r = this.s,
                        n = this.e;
                        return null === n ? r ? (e = "Infinity", r < 0 && (e = "-" + e)) : e = "NaN" : (e = g(this.c), e = null != t && U(t, 2, 64, 25, "base") ? $(k(e, n), 0 | t, 10, r) : n <= H || n >= j ? x(e, n) : k(e, n), r < 0 && this.c[0] && (e = "-" + e)),
                        e
                    },
